 ...
 *	 Fabian Wolf (Adaptions for WordPress theme usage) 
 *
 * all affected sections have comments starting with "PaperG"
 *
 * fwolf - Replaced the direct file access because of some rather moronic WordPress theme policy (the theme that is using this class does not use any of those anyway m( )
